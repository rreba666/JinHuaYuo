...
/* 底部工具栏：价格 + 加购按钮 */
.c-bot { position: absolute; left: 0; right: 0; bottom: 0; display: flex; align-items: center; justify-content: flex-end; gap: 10rpx; padding: 6rpx 10rpx; }
.c-pri { display: flex; align-items: baseline; }
.p-y { color: #0a0a0a; font-size: 20rpx; font-weight: 300; }
.p-n { color: #0a0a0a; font-size: 26rpx; font-weight: 600; margin-left: 2rpx; }
/* 加购按钮：白色圆形 + 号 */
.add-cart-btn { position: relative; width: 44rpx; height: 44rpx; border-radius: 50%; background: rgba(255,255,255,.9); display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
.add-cart-h { position: absolute; width: 18rpx; height: 3rpx; background: #333; border-radius: 2rpx; }
.add-cart-v { position: absolute; width: 3rpx; height: 18rpx; background: #333; border-radius: 2rpx; }
/* 商品名 */
