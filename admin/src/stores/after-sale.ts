...
import { ref } from 'vue'
import { approveAfterSale, getAfterSaleList, receiveAfterSale, rejectAfterSale } from '@/api/after-sale'
...
export const useAfterSaleStore = defineStore('after-sale', () => {
  ...
  return { list, total, page, size, statusFilter, typeFilter, loading, actionLoading, fetchList, approve, reject, receive }
})
