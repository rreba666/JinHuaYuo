...
function createEmptyForm(): AdminProductSaveDTO {
  return { id: undefined, name: '', categoryId: '', mainImage: '', images: [], videoUrl: '', description: '', descriptionTitle: '', originPlace: '', detailImages: [], detailPosterUrl: '', promotionFund: 0, promotionEnabled: 1, dividendFund: 0, dividendEnabled: 1, emergencyPoolEnabled: 0, emergencyPoolAmount: 0, status: 1, isRecommended: 0, recommendTextEnabled: 0, sortOrder: 0, skuList: [] }
}
